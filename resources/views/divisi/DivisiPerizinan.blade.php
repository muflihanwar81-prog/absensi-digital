    ...
    <div class="flex">
        ...
        <div class="flex-1 flex flex-col min-h-screen">
            ...
            <div class="bg-blue-500 p-6 shadow-inner">
                <h2 class="text-3xl font-bold text-gray-800">Data Perizinan</h2> <!-- Sesuai teks di gambar Anda -->
            </div>
            ...
            <div class="p-8">
                ...
                <div class="flex flex-wrap items-center gap-4 mb-6">
                    ...
                    <div class="flex items-center gap-2">
                        <input type="text" placeholder="Rentang Tanggal" class="p-2 bg-gray-300 rounded-lg border-none text-[12px] font-semibold w-36 text-center">
                        <span class="font-bold text-gray-700 text-sm">S/D</span>
                        <input type="text" placeholder="Rentang Tanggal" class="p-2 bg-gray-300 rounded-lg border-none text-[12px] font-semibold w-36 text-center">
                    </div>
                </div>
                ...
                <div class="bg-white border border-gray-400 rounded-sm overflow-hidden">
                    <table class="w-full text-left border-collapse">
                        <thead>
                            <tr class="bg-gray-300 border-b border-gray-400 text-[11px] font-bold text-gray-800 uppercase">
                                ...
                                <th class="py-3 px-3 border-r border-gray-400">Kategori</th>
                                <th class="py-3 px-3 border-r border-gray-400">Bukti</th>
