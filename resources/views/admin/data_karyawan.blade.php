    ...
    <nav class="bg-white border-b shadow-sm px-6 py-3 flex justify-between items-center">
        ...
        <div class="relative">
            <button onclick="toggleDropdown()"
                class="flex items-center gap-2 text-sm bg-gray-200 px-3 py-2 rounded-lg">
        ...
        <main class="flex-1 p-6">
            ...
            <div class="bg-white p-6 rounded-2xl shadow">
                ...
                <div class="flex gap-3 mb-4">
                    ...
                    <form method="GET" action="{{ route('karyawan.index') }}" class="flex gap-2">
                        <input type="text" name="search" placeholder="Cari NIP..." class="border p-2 rounded-lg">
            ...
            <div id="modal"
                ...
                <div class="bg-white w-full max-w-md p-6 rounded-2xl shadow-lg">
                    ...
                    <form action="{{ route('karyawan.store') }}" method="POST" class="space-y-3">
                        @csrf

                        <input type="text" name="nip" placeholder="NIP" class="w-full p-2 border rounded-lg" required>
                        <input type="text" name="nama" placeholder="Nama" class="w-full p-2 border rounded-lg" required>
                        <input type="email" name="email" placeholder="Email" class="w-full p-2 border rounded-lg" required>
                        <input type="password" name="password" placeholder="Password" class="w-full p-2 border rounded-lg" required>
                        <input type="text" name="jabatan" placeholder="Jabatan" class="w-full p-2 border rounded-lg" required>
                        <input type="text" name="divisi" placeholder="Divisi" class="w-full p-2 border rounded-lg" required>
